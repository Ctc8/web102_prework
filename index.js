...
const display = `A total of $${totalRaised.toLocaleString(
  "en-US"
...
let elementDOM = document.createElement("p");
elementDOM.innerHTML = display;
descriptionContainer.appendChild(elementDOM);
